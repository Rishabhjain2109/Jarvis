...
import { Coins, LogOut, MessageSquare, PanelLeftIcon, PanelRight, PenBoxIcon, PenSquare, Plus } from 'lucide-react'
    ...
    if(collapsed){
        return(
            ...
            <div className='relative shrink-0'>
                         {
                            (userData?.avatar && !imageError) ? <img className='w-9 h-9 rounded-[10px] object-cover border-2 border-indigo-500/25'  src={userData?.avatar} alt={"image"} onError={()=>setImageError(true)}/>
                            :
