...
function ChatInput() {
  ...
  return (
    ...
    value={value}
    className="w-full bg-transparent outline-none resize-none text-[14px] text-slate-200 placeholder:text-slate-600 leading-relaxed [scroolbar-width:none] [&::-webkit-scrollbar]:hidden disabled:opacity-50"
    rows={3}
    />
